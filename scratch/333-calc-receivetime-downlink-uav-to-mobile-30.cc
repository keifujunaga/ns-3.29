...
main (int argc, char *argv[])
{
 ...
 Ptr<ListPositionAllocator> uavinitialAlloc = CreateObject<ListPositionAllocator> ();
  ...
  AnimationInterface anim ("333-calc-reveivetime-downlink-uav-to-mobile-30.xml");
  ...
  MobilityHelper::EnableAsciiAll (ascii.CreateFileStream ("333-calc-reveivetime-downlink-uav-to-mobile-30.mob"));
