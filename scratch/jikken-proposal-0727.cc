 ...
 */
  ...
  Simulator::Schedule (timer, &olsr_testApp, 2, SENDER, inter, mode, uid, false);
  //Simulator::Schedule (timer, &olsr_testApp, 3, SENDER, inter, mode, uid, false);
  //Simulator::Schedule (timer, &olsr_testApp, 4, SENDER, inter, mode, uid, false);
