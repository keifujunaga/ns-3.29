...
{  
  std::cout << "srcAddress is " << srcAddress << std::endl;
  std::cout << "destAddress is " << srcAddress << std::endl;
...
main (int argc, char *argv[])
{
  ...
  oss5 << "/NodeList/*/ApplicationList/*/$ns3::PacketSink/RxWithAddresses";
  ...
  Config::Connect (oss5.str (), MakeCallback (&ReceivedPacketWithAddress));
