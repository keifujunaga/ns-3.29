...
public:
   ...
   *   Original
   */
  //void printolsrroutingtable (NodeContainer c, Time unit);
  void aaa (Ptr<Node> node, Ipv4Address addresses[]);
  void aaa2 (Ptr<Node> node, Ipv4Address addresses[]);
  void ExtractIpPred (Ptr<Node> node, std::map<Ipv4Address, double> ipandpred);
  // void setpred (NodeContainer c, int snodenum, double pred);
  void setpred (NodeContainer c, int snodenum, std::map<Ipv4Address, double> preds);
