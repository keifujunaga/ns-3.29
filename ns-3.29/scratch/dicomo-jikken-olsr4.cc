...
main (int argc, char *argv[])
{
  ...
  */
  ...
  // install sinks to application containers
  ...
  */
  ...
  // install onoffhelpers to application containers
  ...
  */
  ...
  if (Simulator::Now ().GetSeconds () >= arrivalTimes[0])
    {
    }

  if (Simulator::Now ().GetSeconds () >= arrivalTimes[1])
    {
    }

  if (Simulator::Now ().GetSeconds () >= arrivalTimes[2])
    {
    }

  if (Simulator::Now ().GetSeconds () >= arrivalTimes[3])
    {
    }

  if (Simulator::Now ().GetSeconds () >= arrivalTimes[4])
    {
    }

  if (Simulator::Now ().GetSeconds () >= arrivalTimes[5])
    {
    }
  */
