...
main (int argc, char **argv)
{
  ...
  std::ifstream ifss ("./111-do-routes-mobility-model-45.mob");
  std::string str;
  if (ifss.fail ())
    {
  ...
  MobilityHelper::EnableAsciiAll (ascii.CreateFileStream ("4-routes-mobility-to-waypoint-mobility.mob"));

  // Animation
  AnimationInterface anim ("4-routes-mobility-to-waypoint-mobility.xml"); // Mandatory
