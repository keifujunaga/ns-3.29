...
#ifndef VIRTUAL_SPRING_MOBILITY_MODEL_H_
#define VIRTUAL_SPRING_MOBILITY_MODEL_H_
...
/**
 * \ingroup mobility
 * \brief VirtualSpringMobilityModel.
 *
 * Each instance moves circularly with a given speed.
 */
class VirtualSpringMobilityModel : public MobilityModel
{
public:
  /**
  ...
  void SetVSMVelocity(Vector velocity);
...
#endif /* VIRTUAL_SPRING_MOBILITY_MODEL_H_ */